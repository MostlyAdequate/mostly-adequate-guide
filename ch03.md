...
Functions can be described as a set of pairs with the position (input, output), with no repeated inputs: `[(1,2), (3,6), (5,10)]` (It appears this function doubles its input).

Or perhaps a similar table:
